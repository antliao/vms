...
function addV_form()
{
	...
	echo "<td><select name=\"Vsex\"><option value=\"male\">男</option><option value=\"female\">女</option></select></td>" ;
	echo "<td><input type=\"text\" name=\"Vdistrict\" maxlength=\"20\"</td>" ;
	echo "<td><input type=\"text\" name=\"Vclass\" maxlength=\"20\"</td>" ;
	echo "<td><select name=\"Vstatus\"><option value=\"enable\">啟用</option><option value=\"disable\">停用</option></select></td>" ;
